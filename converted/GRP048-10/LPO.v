...
Complete product_substitution3 associativity2 associativity1 total_function2 total_function1 left_inverse left_identity ifeq_axiom : equalish identity ifeq inverse multiply product true : hint
  for ((equalish a b) = true).
